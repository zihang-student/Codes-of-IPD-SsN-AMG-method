function [zeta,itamg,resamg,info] = Hybrid_twogrid(prob_data,amg_options)
% Original system:
%                   He * zeta = z
...
if length(sizes) == 1 % A0/H0 is connected
    ...
    [u,itamg,resamg] = twogrid_bigph(Ae,f,amg_options);it_num = 1;
end
%% Otherwise Case 2
if length(sizes) > 1  % A0/H0 is disconnected
    ...
    if ~isempty(large_size)
        for k = large_size
            ...
            [dk,itamgk,resamgk] = twogrid_bigph(Aek,fk,amg_options);            
